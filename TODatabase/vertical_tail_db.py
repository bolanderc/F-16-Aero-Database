...
if __name__=="__main__":
    ...
    # Initialize airfoil
    airfoil = adb.Airfoil("4biconvex", airfoil_input, verbose=True)
    ...
    # With Rey computed from MAC of 6.8375 ft
    dofs = {
        "alpha" : {
    ...
    airfoil.export_database(filename="vertical_tail_database.txt")
    ...
    airfoil.generate_linear_model(plot_model=True, Rey=9447400.0, Mach=0.2)
    ...
    # Export fits
    airfoil.export_polynomial_fits(filename="vertical_tail_fits.json")
