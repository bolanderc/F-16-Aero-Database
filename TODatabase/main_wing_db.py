...
if __name__=="__main__":
    ...
    # Initialize airfoil
    airfoil = adb.Airfoil("64A204", airfoil_input, verbose=False)
    ...
    # With Rey computed from MAC of 11.32 ft
    dofs = {
        "alpha" : {
    ...
    airfoil.generate_database(degrees_of_freedom=dofs, max_iter=300, show_xfoil_output=False)
    airfoil.export_database(filename="main_wing_database.txt")
    ...
    # Export fits
    airfoil.export_polynomial_fits(filename="main_wing_fits.json")
